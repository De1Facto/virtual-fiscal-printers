...
public class IslDepositOrWithdrawMoneyCommand implements Command {
    ...
    public IslDepositOrWithdrawMoneyCommand(Boolean isWithdraw, Short paymentType, Long amount) {
        this.isWithdraw = isWithdraw;
        this.paymentType = paymentType;
        this.amount = amount;
    }

    public static IslDepositOrWithdrawMoneyCommand fromString(String s) {
